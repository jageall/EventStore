...
namespace EventStore.Core.Tests.Services.Storage.MaxAgeMaxCount
{
    public class when_having_stream_both_maxage_and_maxcount_specified_with_maxcount_more_strict : ReadIndexTestScenario
    {
        ...
        protected override void WriteTestScenario()
        {
            ...
            var r2 = Fixture.WriteSingleEvent("ES", 0, "bla1", now.AddMinutes(-100));
            var r3 = Fixture.WriteSingleEvent("ES", 1, "bla1", now.AddMinutes(-20));
            var r4 = Fixture.WriteSingleEvent("ES", 2, "bla1", now.AddMinutes(-11));
        ...
        public when_having_stream_both_maxage_and_maxcount_specified_with_maxcount_more_strict(FixtureData fixture) : base(fixture)
        {
        }
    }
}