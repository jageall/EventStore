...
namespace EventStore.Core.Tests.Services.Storage.MaxAgeMaxCount.ReadRangeAndNextEventNumber
{
    public class when_reading_stream_with_max_count: ReadIndexTestScenario
    {
        ...
        {
            Fixture.WriteStreamMetadata("ES", 0, @"{""$maxCount"":3}");
            Fixture.WriteSingleEvent("ES", 0, "bla");
            Fixture.WriteSingleEvent("ES", 1, "bla");
            var event3 = Fixture.WriteSingleEvent("ES", 2, "bla");
            var event4 = Fixture.WriteSingleEvent("ES", 3, "bla");
            var event5 = Fixture.WriteSingleEvent("ES", 4, "bla");
        ...
        public when_reading_stream_with_max_count(FixtureData fixture) : base(fixture)
        {
        }
    }
}
