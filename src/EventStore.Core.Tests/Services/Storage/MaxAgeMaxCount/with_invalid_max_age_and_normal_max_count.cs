...
namespace EventStore.Core.Tests.Services.Storage.MaxAgeMaxCount
{
    public class with_invalid_max_age_and_normal_max_count : ReadIndexTestScenario
    {
        ...
        protected override void WriteTestScenario()
        {
            ...
            _r1 = Fixture.WriteStreamMetadata("ES", 0, metadata);
            _r2 = Fixture.WriteSingleEvent("ES", 0, "bla1", now.AddSeconds(-50));
            _r3 = Fixture.WriteSingleEvent("ES", 1, "bla1", now.AddSeconds(-20));
            _r4 = Fixture.WriteSingleEvent("ES", 2, "bla1", now.AddSeconds(-11));
            _r5 = Fixture.WriteSingleEvent("ES", 3, "bla1", now.AddSeconds(-5));
            _r6 = Fixture.WriteSingleEvent("ES", 4, "bla1", now.AddSeconds(-1));
        }
        ...
        public with_invalid_max_age_and_normal_max_count(FixtureData fixture) : base(fixture)
        {
        }
    }
}