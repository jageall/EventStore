...
namespace EventStore.Core.Tests.Services.Storage.Metastreams
{
    ...
    {
        public when_having_deleted_stream_and_no_metastream_metastream_is_declared_deleted_as_well(FixtureData fixture) :base(fixture)
        {
        ...
        {
            Assert.Equal(ReadStreamResult.StreamDeleted, ReadIndex.ReadStreamEventsBackward("$$test", 0, 100).Result);
        }
    }
}
