...
namespace EventStore.Core.Tests.Services.Storage.Transactions
{
    public class when_having_two_intermingled_transactions_read_index_should : ReadIndexTestScenario
    {
        ...
        protected override void WriteTestScenario()
        {
            ...
            var p1 = Fixture.WriteTransactionEvent(t1.CorrelationId, t1.LogPosition, 0, t1.EventStreamId, 0, "es1", PrepareFlags.Data);
            var p2 = Fixture.WriteTransactionEvent(t2.CorrelationId, t2.LogPosition, 0, t2.EventStreamId, 0, "abc1", PrepareFlags.Data);
            var p3 = Fixture.WriteTransactionEvent(t1.CorrelationId, t1.LogPosition, 1, t1.EventStreamId, 1, "es1", PrepareFlags.Data);
            var p4 = Fixture.WriteTransactionEvent(t2.CorrelationId, t2.LogPosition, 1, t2.EventStreamId, 1, "abc1", PrepareFlags.Data);
            var p5 = Fixture.WriteTransactionEvent(t1.CorrelationId, t1.LogPosition, 2, t1.EventStreamId, 2, "es1", PrepareFlags.Data);
        ...
        public when_having_two_intermingled_transactions_read_index_should(FixtureData fixture) : base(fixture)
        {
        }
    }
}