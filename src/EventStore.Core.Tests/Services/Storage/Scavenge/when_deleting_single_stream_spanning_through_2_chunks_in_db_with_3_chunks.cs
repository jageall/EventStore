...
namespace EventStore.Core.Tests.Services.Storage.Scavenge
{
    public class when_deleting_single_stream_spanning_through_2_chunks_in_db_with_3_chunks :ReadIndexTestScenario
    {
        ...
        public when_deleting_single_stream_spanning_through_2_chunks_in_db_with_3_chunks(FixtureData fixture):base(fixture)
        {
        ...
        protected override void WriteTestScenario()
        {
            ...
            var event8 = Fixture.WriteSingleEvent("ES2", 0, new string('.', 5000), retryOnFail: true); //chunk 3

            var delete = Fixture.WriteDelete("ES");
            Fixture.Scavenge(completeLast: false, mergeChunks: false);
            Fixture.AddStashedValueAssignment(this, instance =>
            {
                instance._event8 = event8;
