...
namespace EventStore.Core.Tests.Services.Storage.Scavenge
{
    ...
    {
        public when_stream_is_softdeleted_and_temp_but_some_events_are_in_multiple_chunks(Fixture fixture) : base(fixture)
        {
        ...
        public void the_stream_is_present_physically()
        {
            ...
            Assert.Equal(1, ReadIndex.ReadAllEventsForward(new TFPos(0, 0), 1000).Records.Count(x => x.Event.EventStreamId == "test"));
            Assert.Equal(1, ReadIndex.ReadAllEventsBackward(headOfTf, 1000).Records.Count(x => x.Event.EventStreamId == "test"));
        }
