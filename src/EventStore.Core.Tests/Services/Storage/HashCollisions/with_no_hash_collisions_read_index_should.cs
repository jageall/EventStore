...
namespace EventStore.Core.Tests.Services.Storage.HashCollisions
{
    public class with_no_hash_collisions_read_index_should: ReadIndexTestScenario
    {
        ...
        {
            var prepare1 = Fixture.WriteSingleEvent("ES", 0, "test1");

            var prepare2 = Fixture.WriteSingleEvent("ESES", 0, "test2");
            var prepare3 = Fixture.WriteSingleEvent("ESES", 1, "test3");
        ...
        public with_no_hash_collisions_read_index_should(FixtureData fixture) : base(fixture)
        {
        }
    }
}