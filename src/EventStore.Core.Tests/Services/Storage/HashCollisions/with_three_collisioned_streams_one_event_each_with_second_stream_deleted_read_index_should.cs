...
namespace EventStore.Core.Tests.Services.Storage.HashCollisions
{
    public class with_three_collisioned_streams_one_event_each_with_second_stream_deleted_read_index_should : ReadIndexTestScenario
    {
        ...
        protected override void WriteTestScenario()
        {
            ...
            var delete2 = Fixture.WriteDelete("CD");
        ...
        public with_three_collisioned_streams_one_event_each_with_second_stream_deleted_read_index_should(FixtureData fixture) : base(fixture)
        {
        }
    }
}