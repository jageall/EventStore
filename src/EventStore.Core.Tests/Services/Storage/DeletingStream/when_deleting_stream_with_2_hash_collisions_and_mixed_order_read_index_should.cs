...
namespace EventStore.Core.Tests.Services.Storage.DeletingStream
{
    public class when_deleting_stream_with_2_hash_collisions_and_mixed_order_read_index_should : ReadIndexTestScenario
    {
        protected override void WriteTestScenario()
        {
            ...
            Fixture.WriteSingleEvent("S3", 0, "bla1");
        ...
        public when_deleting_stream_with_2_hash_collisions_and_mixed_order_read_index_should(FixtureData fixture) : base(fixture)
        {
        }
    }
}