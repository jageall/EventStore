...
namespace EventStore.Core.Tests.Services.Storage.BuildingIndex
{
    public class when_building_an_index_off_tfile_with_multiple_events_in_a_stream : ReadIndexTestScenario
    {
        ...
        protected override void WriteTestScenario()
        {
            ...
            Fixture.Writer.Write(new PrepareLogRecord(0, _id1, _id1, 0, 0, "test1", ExpectedVersion.NoStream, DateTime.UtcNow,
                                              PrepareFlags.SingleWrite, "type", new byte[0], new byte[0]),
                         out pos1);
            Fixture.Writer.Write(new PrepareLogRecord(pos1, _id2, _id2, pos1, 0, "test1", 0, DateTime.UtcNow,
                                              PrepareFlags.SingleWrite, "type", new byte[0], new byte[0]),
                         out pos2);
        ...
        public when_building_an_index_off_tfile_with_multiple_events_in_a_stream(FixtureData fixture) : base(fixture)
        {
        }
    }
}