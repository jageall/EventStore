...
namespace EventStore.Core.Tests.Services.Storage.CheckCommitStartingAt
{
    public class when_writing_few_prepares_with_same_expected_version_and_not_committing_them :ReadIndexTestScenario
    {
        ...
        {
            _prepare0 = Fixture.WritePrepare("ES", -1);
            _prepare1 = Fixture.WritePrepare("ES", -1);
            _prepare2 = Fixture.WritePrepare("ES", -1);
        }
        ...
        public when_writing_few_prepares_with_same_expected_version_and_not_committing_them(FixtureData fixture) : base(fixture)
        {
        }
    }
}
