...
{
    public class when_merging_four_ptables: IClassFixture<when_merging_four_ptables.FixtureData>
    {
        ...
        public class FixtureData : SpecificationWithDirectoryPerTestFixture
        {
            ...
            public readonly PTable _newtable;
        ...
        {
            Assert.Equal(40, _newtable.Count);
        }
