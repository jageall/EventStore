...
{
    public class adding_two_items_to_empty_index_map_with_two_tables_per_level_causes_merge: IClassFixture<MergeFileFixture>
    {
        ...
        public adding_two_items_to_empty_index_map_with_two_tables_per_level_causes_merge(MergeFileFixture data)
        {
