...
{
    public class when_appending_to_a_tfchunk_and_flushing : IClassFixture<when_appending_to_a_tfchunk_and_flushing.FixtureData>
    {
        ...
        public when_appending_to_a_tfchunk_and_flushing(FixtureData data)
        {
