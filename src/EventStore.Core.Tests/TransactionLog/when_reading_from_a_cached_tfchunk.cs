...
{
    public class when_reading_from_a_cached_tfchunk : IClassFixture<when_reading_from_a_cached_tfchunk.FixtureData>
    {
        ...
        public when_reading_from_a_cached_tfchunk(FixtureData data)
        {
