...
namespace EventStore.Core.Messages {
	public static class StorageMessage {
		...
		public class EffectiveStreamAclRequest : Message {
			...
			public EffectiveStreamAclRequest(string streamId, IEnvelope envelope) {
				StreamId = streamId;
				Envelope = envelope;
			}
		...
		public class EffectiveAcl {
			...
			public static Task<EffectiveAcl> LoadAsync(IPublisher publisher, string streamId) {
				var envelope = new RequestEffectiveAclEnvelope();
				publisher.Publish(new StorageMessage.EffectiveStreamAclRequest(streamId, envelope));
			...
			class RequestEffectiveAclEnvelope : IEnvelope {
				...
				public void ReplyWith<T>(T message) where T : Message {
					...
					if (message is StorageMessage.EffectiveStreamAclResponse response) {
