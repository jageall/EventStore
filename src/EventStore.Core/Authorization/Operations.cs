	...
	public static class Operations {
		...
		public static class Node {
			...
			public static class Information {
				...
				public static readonly OperationDefinition Subsystems = new OperationDefinition(Resource + "/subsystems", "read");
				public static readonly OperationDefinition Histogram = new OperationDefinition(Resource + "/histograms", "read");
				public static readonly OperationDefinition Read = new OperationDefinition(Resource, "read");
				public static readonly OperationDefinition Options = new OperationDefinition(Resource + "/options", "read");
			}

			public static class Statistics {
				private const string Resource = Node.Resource + "/stats";
				public static readonly OperationDefinition Read = new OperationDefinition(Resource, "read");
				public static readonly OperationDefinition Replication = new OperationDefinition(Resource + "/replication", "read");
				public static readonly OperationDefinition Tcp = new OperationDefinition(Resource + "/tcp", "read");
				public static readonly OperationDefinition Custom = new OperationDefinition(Resource + "/custom", "read");
			}
			...
			public static class Elections {
				...
				public static readonly OperationDefinition ViewChangeProof = new OperationDefinition(Resource, "viewchangeproof");
				...
				public static readonly OperationDefinition MasterIsResigning = new OperationDefinition(Resource, "masterisresigning");
				public static readonly OperationDefinition MasterIsResigningOk = new OperationDefinition(Resource, "masterisresigningok");
			}
		...
		public static class Streams {
			...
			public static readonly OperationDefinition MetadataWrite = new OperationDefinition(Resource, "metadataWrite");

			public static class Parameters {
				public static Parameter StreamId(string streamId) => new Parameter("streamId", streamId);
				public static Parameter TransactionId(long transactionId) => new Parameter("transactionId", transactionId.ToString("D"));
			}
		}
		...
		public static class Users {
			...
			public static readonly OperationDefinition ChangePassword = new OperationDefinition(Resource, "updatePassword");
		...
		public static class Projections {
			...
			public static readonly OperationDefinition ReadConfiguration = new OperationDefinition(Resource+"/configuration", "read");
			public static readonly OperationDefinition UpdateConfiguration = new OperationDefinition(Resource+"/configuration", "update");
